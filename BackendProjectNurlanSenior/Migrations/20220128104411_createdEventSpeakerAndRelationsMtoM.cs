...
{
    public partial class createdEventSpeakerAndRelationsMtoM : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DayMonth = table.Column<DateTime>(nullable: false),
                    ...
                    LeaveReply = table.Column<string>(maxLength: 300, nullable: false)
                },
                constraints: table =>
                {
